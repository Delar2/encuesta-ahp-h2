...
El objetivo de esta encuesta es determinar, de manera estructurada y transparente, la importancia relativa de diferentes **técnicas analíticas** en la detección de hidrógeno natural en muestras provenientes del trabajo en campo.
...
if st.session_state.current_step == 0:
    ...
    image_path = Path("imagen_analitica.png")
    if image_path.exists():
        st.image(
            str(image_path),
            caption="Alternativas analíticas evaluadas",
